...
; takes as input a procedure, f, that itself takes one input. The re-
; sult returned by make-monitored is a third procedure, say mf, that
; keeps track of the number of times it has been called by main-
; taining an internal counter. If the input to mf is the special sym-
; bol how-many-calls?, then mf returns the value of the counter. If
