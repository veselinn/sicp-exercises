...
; contains the region. For example, a rectangle with diagonally op-
; posite corners at (2, 4) and (8, 10) contains the circle above. The
...
; above to estimate π. Use your estimate-integral to produce an
; estimate of π by measuring the area of a unit circle.
; You will find it useful to have a procedure that returns a number
; chosen at random from a given range. The following random-in-
; range procedure implements this in terms of the random proce-
; dure used in Section 1.2.6, which returns a nonnegative number
; less than its input.
; 
